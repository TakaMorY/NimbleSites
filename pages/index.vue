                ...
                <div class="container mx-auto px-4 py-12">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 transition-all">
                        ...
                        <div
                            ...
                            <div class="bg-[#7216f4]/20 text-sm px-3 py-1 rounded-full mb-3 inline-block">2-14 дней
                            </div>
                        ...
                        <div
                            ...
                            <div class="bg-[#7216f4]/20 text-sm px-3 py-1 rounded-full mb-3 inline-block">Моментально
                            </div>
                ...
                <div id="features" class="scroll-mt-20">
                    <div class="relative mx-auto max-w-5xl text-center">
                        ...
                        <p
                            ...
                            Наши шаблоны допускают максимальную индивидуализацию. А в сайты, созданные с нуля, мы
                            вкладываем
                            всю душу.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <div
                            class="rounded-xl border relative border-transparent p-8 text-center shadow bg-white transition-all duration-300 transform hover:-translate-y-1 relative overflow-hidden">
                            <div
                        ...
                        <div
                            ...
                            <p class="my-4 mb-0 font-normal leading-relaxed tracking-wide ">Мы разрабатываем
                                наши
                                сайты с
                                учетом скорости и сверхбыстрого времени загрузки, чтобы ваши клиенты никогда не
                                сомневались.
                            </p>
                        </div>
                        ...
                        <div class="relative mt-12 lg:mt-20">
                            <div class="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
                                ...
                                <div>
                                    ...
                                    <h3 class="mt-6 text-xl  font-semibold leading-tight md:mt-10">Получите готовый
                                        товар
                                    </h3>
                                    <p class="mt-4 text-base  md:text-lg">
